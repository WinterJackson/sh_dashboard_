  ...
  return (
    <div className='flex flex-col w-full h-full gap-4'>
        <div className="flex justify-between items-center gap-20">
            <p className='capitalize '>Edit your notifications preferences here</p>
            ...
            <div className="bg-white flex flex-col gap-5 p-5 shadow-lg rounded-xl">
                <div className="flex justify-between items-end max-w-[900px] ">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='capitalize'>Recieve notifications for upcoming appointments and bookings. </p>
                    </div>
                ...
                <div className="flex justify-between items-end max-w-[900px] ">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='capitalize'>Stay informed with email alerts and updates.</p>
                    </div>
                    <button className='flex'>
                        <Toggle/>
                    </button>
                ...
                <div className="flex justify-between items-end max-w-[900px] ">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='capitalize'>stay Up-to-date with the latest system improvements and changes.</p>
                    </div>
                    <button className='flex'>
                        <Toggle/>
                    </button>
                ...
                <div className="flex justify-between items-end max-w-[900px] ">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className='capitalize'>Be notified when a new device logs into your account.</p>
                    </div>
                    <button className='flex'>
                        <Toggle/>
                    </button>
