                ...
                <div className="flex flex-col gap-7 p-4 w-1/3 min-w-80 rounded bg-white">
                    <div className="flex gap-4 items-center  xxl:justify-start justify-center  flex-wrap">
                        ...
                        <div className="flex flex-col gap-3 ">
                            ...
                            <p className="text-gray-400 font-semibold flex justify-between">
                                <span className="font-light">Date Joined:</span>{" "}
                                <span>6/9/23</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-2 ">
                            <div className="flex gap-4 items-center">
                                ...
                                <span className="font-bold capitalize w-2/3">
                                    Married
                                </span>
                            </div>
                            <div className="flex gap-4 items-center">
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <span className="font-bold  w-2/3 truncate">
                                    Albertehimoroo@gmail.commmmmmmmmmm
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-2 ">
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <span className="font-bold w-2/3 truncate">
                                    janeehimoroo@gmail.commmmmmmmmmm
                                </span>
                            </div>
                        </div>
                    </div>
                    <button className="border-2 border-primary font-bold hover:border-accent bg-primary hover:bg-accent text-white p-3 w-52 rounded-xl self-center">
                        Add Appointment
                    </button>
                    <button className="border-4 border-black font-bold hover:border-accent hover:bg-accent hover:text-white p-3 w-52 rounded-xl self-center">
                        Send Message
                    </button>
                </div>
                {/* right */}
                        ...
                        <div className="flex flex-col gap-2 bg-white w-1/2 rounded p-4">
                            ...
                            <div className="bg-slate-100 p-5 rounded-xl">
                                <p>
                                    ...
                                    architecto cumque ad quos quod accusantium
                                    dolores repellendus voluptatem, consequatur
                                    ullam quasi porro dicta illo corrupti, dolor
                                    expedita enim culpa! <br />
                                    Recusandae provident modi aliquam maiores
                                    placeat fugit consequatur eaque! Iusto,
                                    dignissimos quas possimus atque rem
                                    molestias sint minima quasi repellat
                                    voluptatem soluta repudiandae ex velit
                                    beatae accusantium error veniam vero.
                                </p>
                            </div>
                        </div>
                        {/* Files / Documents */}
