// File: src/app/api/auth/register/admin/route.ts
...
export async function POST(req: Request) {
    ...
    const { email, username, hospitalId } = await req.json();
    ...
    await prisma.auditLog.create({
        data: {
            ...
            status: "TOKEN_ISSUED",
            meta: {
                reason: "Admin user creation triggers reset",
    ...
    return NextResponse.json({ message: "Admin created. Email sent." });
}
