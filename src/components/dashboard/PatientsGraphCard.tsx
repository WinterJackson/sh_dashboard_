// src/components/dashboard/PatientsGraphCard.tsx
...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, Label, Cross } from "recharts";
...
const PatientsGraphCard = () => {
    const sessionData = useSessionData();
    const role = sessionData?.user?.role;
    const hospitalId = sessionData?.user?.hospitalId;

    // const [appointmentsData, setAppointmentsData] = useState<PatientCountPerMonth[]>([]); // correct code
        ...
        <div className="grid p-4 rounded-2xl xl:pb-5 bg-slate-100 shadow-lg shadow-gray-300">
            ...
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <Tooltip />
                    <Legend align='right' />
                    <Bar dataKey="count" fill="#016BD2" background={{ fill: '#dbedff' }}  maxBarSize={40} legendType='circle' radius={[10, 10, 0, 0]} />
                </BarChart>
            </ResponsiveContainer>
        </div>
    );
