// src/app/components/doctors/DoctorsCard.tsx
        ...
        <div className="flex-1 min-w-[330px] max-w-[400px]">
            <div className=" relative flex justify-center flex-1 min-w-[330px] max-w-[400px] gap-4 items-center border-2 border-bluelight rounded-xl p-6">
                ...
                <div className="flex flex-col gap-3">
                    <h1 className="text-lg capitalize" onClick={handleShowBio}>
                        Gynecologist
                    </h1>
                    <div
                    ...
                    <button className="p-2 border-2 border-primary text-primary hover:bg-blue-300 hover:text-black hover:border-blue-300 font-semibold rounded-xl">
                        Appoint Doctor
                    </button>
                </div>
            </div>
            {showBio && <DoctorBio cancel={handleShowBio} />}
        </div>
    );
}
